  ...
  const renderRiskBadge = (riskLevel?: string | null) => {
    ...
    const riskConfig = {
      ...
      high: {
        ...
        text: 'High risk – review carefully'
      }
    };

    const config = riskConfig[riskLevel.toLowerCase() as keyof typeof riskConfig] || riskConfig.medium;

    return (
      <span className={`px-2 py-0.5 text-xs rounded border ${config.color}`}>
        {config.text}
      </span>
    );
  };
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex-1">
              <h4 className="font-semibold text-blue-300 mb-1 flex items-center gap-2">
                ...
                New: Agent Assist stages
              </h4>
              <p className="text-sm text-blue-200/80">
                These stages ask the agent to propose a plan or patch. You stay in control: review and decide if and how to apply changes.
              </p>
            </div>
            <button
          ...
          {(recommendation || error) && (
            <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-3">
              <p className="text-sm text-gray-300 flex items-start gap-2">
                ...
                <span>These suggestions are generated by the agent. Always review before applying changes.</span>
              </p>
            </div>
          )}
          ...
          {autoApplyResult && (
            <div className="mt-4 pt-4 border-t border-gray-800">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-medium text-gray-300">Automated Agent Apply Result</span>
              </div>
              <p className="text-xs text-gray-400 mb-3">
                This workflow was configured to auto-apply agent changes for this stage.
              </p>
              ...
              {autoApplyResult.success ? (
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <h4 className="font-semibold text-green-300">Auto-applied</h4>
                        <span className="px-2 py-0.5 text-xs bg-green-900/50 text-green-200 border border-green-700 rounded">
                          Automated
                        </span>
                      </div>
                ...
                <div className="bg-red-900/20 border border-red-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <h4 className="font-semibold text-red-300">Auto-apply failed</h4>
                        <span className="px-2 py-0.5 text-xs bg-red-900/50 text-red-200 border border-red-700 rounded">
                          Automated
                        </span>
                      </div>
