...
#Preview {
    ModelEvictionDialog(
        ...
        hotSlots: [
            HotSlot(slotNumber: 1, modelId: "llama3.2:3b", modelName: "Llama 3.2 3B", isPinned: false, isLoaded: true, loadedAt: Date().addingTimeInterval(-3600), memoryUsageGB: 3.2),
            HotSlot(slotNumber: 2, modelId: "phi-3.5:3.8b", modelName: "Phi-3.5 3.8B", isPinned: true, isLoaded: true, loadedAt: Date().addingTimeInterval(-1800), memoryUsageGB: 4.1),
        ],
        onAutoReplace: { },
        onManualSelect: { _ in },
        onCancel: { }
