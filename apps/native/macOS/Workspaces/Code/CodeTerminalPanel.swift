...
//
// Terminal panel with session tabs — embedded in CodeWorkspace below the editor.
// Toggle via activity bar terminal button. Context menu for external terminal option.
//
