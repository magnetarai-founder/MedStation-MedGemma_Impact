...
from api.p2p_chat_router import (
    router,
    _channel_invitations,
    _read_receipts,
    active_connections,
    broadcast_event,
)
...
def clear_state():
    ...
    _channel_invitations.clear()
    _read_receipts.clear()
...
class TestInitializeEndpoint:
    ...
    def test_initialize_success(self, client, mock_p2p_service):
        ...
        with patch('api.p2p_chat_router.init_p2p_chat_service', return_value=mock_p2p_service):
    ...
    def test_initialize_failure(self, client):
        ...
        with patch('api.p2p_chat_router.init_p2p_chat_service', side_effect=Exception("Failed to start")):
            response = client.post(
                "/api/v1/team/initialize",
...
class TestStatusEndpoint:
    ...
    def test_get_status_success(self, client, mock_p2p_service, sample_peer, sample_channel):
        ...
        with patch('api.p2p_chat_router.get_p2p_chat_service', return_value=mock_p2p_service):
    ...
    def test_get_status_service_none(self, client):
        ...
        with patch('api.p2p_chat_router.get_p2p_chat_service', return_value=None):
            response = client.get("/api/v1/team/status")
...
class TestChannelEndpoints:
    ...
    def test_create_channel_success(self, client, mock_p2p_service, sample_channel):
        ...
        with patch('api.p2p_chat_router.get_p2p_chat_service', return_value=mock_p2p_service):
            with patch('api.p2p_chat_router.broadcast_event', new_callable=AsyncMock):
                response = client.post(
...
class TestChannelInvitations:
    ...
    def test_invite_duplicate(self, client, mock_p2p_service, sample_channel):
        ...
        _channel_invitations["channel-789"] = [{
            "peer_id": "peer-1",
            "channel_id": "channel-789",
    ...
    def test_accept_invitation_success(self, client, mock_p2p_service, mock_current_user):
        ...
        assert _channel_invitations["channel-789"][0]["status"] == "accepted"
