"""
Redshift SQL Processor Core Module

Provides robust SQL processing that mimics Redshift/DataCentral behavior using DuckDB.

This module contains the main RedshiftSQLProcessor class and convenience functions.
Constants and utilities are imported from sibling modules.
"""
...
from redshift_sql_processor.constants import (
    RESERVED_WORDS,
    REGEX_PATTERNS,
    IDENTIFIER_PATTERNS,
    NUMERIC_PATTERNS,
)
from redshift_sql_processor.utils import (
    clean_identifier,
    normalize_casts_text,
    is_literal,
    already_cast,
    scan_left_boundary,
    scan_right_boundary,
    apply_column_mapping_to_sql,
    escape_sheet_name,
)
...
class RedshiftSQLProcessor:
    ...
    # Use pre-compiled regex patterns from constants module
    ...
    # Static method delegates to utility functions for backward compatibility
    @staticmethod
