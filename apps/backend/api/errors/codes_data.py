#!/usr/bin/env python3
"""
Error Codes Data - Static error code definitions and messages

Extracted from error_codes.py during P2 decomposition.
Contains:
- ErrorCode enum with standardized error codes
- ERROR_MESSAGES dict mapping codes to user-friendly messages
