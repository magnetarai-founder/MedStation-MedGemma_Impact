"""
Permissions service for ElohimOS - Business logic for RBAC management.

Handles permissions, profiles, permission sets, and user permission management.
...
def _get_db_connection() -> sqlite3.Connection:
    """Get connection to auth database with row factory"""
    try:
