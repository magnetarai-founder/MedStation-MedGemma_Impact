...
async def run_startup_migrations() -> None:
    ...
    try:
        ...
        # Import migrations (all in api.migrations package)
        from api.migrations import phase0_user_db as phase0_migration
        from api.migrations import phase1_workflows_user_id as phase1_migration
        from api.migrations import phase1_5_per_user_models as phase1_5_migration
        from api.migrations import phase1b_password_reset as phase1b_migration
        from api.migrations import phase2_permissions_rbac as phase2_migration
        from api.migrations import phase25_rbac_hardening as phase25_migration
        from api.migrations import phase3_team_mode as phase3_migration
        from api.migrations import phase35_workflow_type as phase35_migration
        from api.migrations import phase4_performance_indexes as phase4_migration
        # Sprint 6 analytics migrations
        from api.migrations import phase6_analytics as phase6_analytics_migration
        from api.migrations import phase6_model_kpis as phase6_kpis_migration
        # Phase B: Kanban workspace
        from api.migrations import phaseB_kanban as phaseB_kanban_migration
