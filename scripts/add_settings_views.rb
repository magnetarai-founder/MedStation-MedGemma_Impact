...
files_to_add = [
  { path: 'macOS/Settings/SettingsHelpers.swift', group: 'macOS/Settings' },
  { path: 'macOS/Settings/MagnetarCloudSettingsView.swift', group: 'macOS/Settings' },
  { path: 'macOS/Settings/ModelManagementSettingsView.swift', group: 'macOS/Settings' },
  { path: 'macOS/Settings/SecuritySettingsView.swift', group: 'macOS/Settings' },
  { path: 'macOS/Settings/APISettingsView.swift', group: 'macOS/Settings' },
  { path: 'macOS/Settings/GeneralSettingsView.swift', group: 'macOS/Settings' },
  { path: 'macOS/Settings/AppearanceSettingsView.swift', group: 'macOS/Settings' }
]
...
puts "🔧 Adding settings view files to Xcode project..."
puts ""
...
puts "✅ Done! All settings view files added to Xcode project."
